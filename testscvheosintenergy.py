#!/usr/bin/env python2
"""
Plot u(rho, T) for different isotherms.
"""
...
def main():
    ...
    Internal energy.
    """
    data = numpy.loadtxt("testscvheosintenergy.txt")
    
    num_isotherms = numpy.size(data[0,1:])
    
    logrho = data[:,0]
    logu   = data[:,1:num_isotherms+1]
    ...
    savefig('testscvheosintenergy.png', dpi=300, bbox_inches='tight')
