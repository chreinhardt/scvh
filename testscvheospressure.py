#!/usr/bin/env python2
"""
Plot P(rho, T) for different isotherms.
"""
...
def main():
    ...
    Pressure.
    """
    data = numpy.loadtxt("testscvheospressure.txt")
    
    num_isotherms = numpy.size(data[0,1:])
    
    logrho = data[:,0]
    logP   = data[:,1:num_isotherms+1]
    ...
    savefig('testscvheospressure.png', dpi=300, bbox_inches='tight')
    ...
    savefig('testscvheospressure_zoom.png', dpi=300, bbox_inches='tight')
